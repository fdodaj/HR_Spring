...
INSERT INTO user(id, first_name, last_name, email, password, birthday, gender, hire_date, paid_time_off, deleted, user_role, user_department) VALUES(1, 'Florian', 'Dodaj', 'florian@gmail.com', '$2a$10$fAb5yDYznme2vPNov0KY1eyJfNFo4yteoeC/V1oRhJNgwwvzn52B6', '2022-02-02', 'male', '2022-02-02', 25, false, 1,1);
INSERT INTO user(id, first_name, last_name, email, password, birthday, gender, hire_date, paid_time_off, deleted, user_role, user_department) VALUES(2, 'John', 'Smith', 'smith@gmail.com', '$2a$10$fAb5yDYznme2vPNov0KY1eyJfNFo4yteoeC/V1oRhJNgwwvzn52B6', '2021-01-02', 'male', '2000-02-02', 12, false, 2,2);
INSERT INTO user(id, first_name, last_name, email, password, birthday, gender, hire_date, paid_time_off, deleted, user_role, user_department) VALUES(3, 'Mary', 'Jane', 'jane@gmail.com', '$2a$10$fAb5yDYznme2vPNov0KY1eyJfNFo4yteoeC/V1oRhJNgwwvzn52B6', '2006-01-02', 'female', '2012-02-02', 15, false, 3,3);
INSERT INTO user(id, first_name, last_name, email, password, birthday, gender, hire_date, paid_time_off, deleted, user_role, user_department) VALUES(4, 'Marko', 'Obama', 'obama@gmail.com', '$2a$10$fAb5yDYznme2vPNov0KY1eyJfNFo4yteoeC/V1oRhJNgwwvzn52B6', '2005-06-02', 'male', '2010-09-02', 20, false, 4,4);

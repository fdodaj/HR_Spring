...
INSERT INTO request(id,from_date, to_date, reason, business_days, request_status, deleted, user_id) values (1, '2022-02-02', '2022-02-05', 'Vacation', 2, 'Pending', false, 2);
INSERT INTO request(id,from_date, to_date, reason, business_days, request_status, deleted, user_id) values (2, '2022-02-02', '2022-03-02', 'Traveling abroad', 24, 'Approved', false, 1);
INSERT INTO request(id,from_date, to_date, reason, business_days, request_status, deleted, user_id) values (3, '2021-05-02', '2021-05-06', 'Time with family', 2, 'Rejected', false, 3);
